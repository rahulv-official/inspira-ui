...
icon: "lucide:play"[https://github.com/unovue/inspira-ui/blob/main/content/1.getting-started/2.installation.md](https://github.com/unovue/inspira-ui/blob/main/content/1.getting-started/2.installation.md)
---

本指南将帮助你在 Vue 或 Nuxt 应用中安装并配置 Inspira UI 组件。

::warning
如果你正在使用 Tailwind CSS v3，**[请在这里查看 Inspira UI v1](https://v1.inspira-ui.com)。**
::
